...
export default function NextjsCoursePage() {
  ...
  if (startLearning && !loading) {
    return <CourseViewer courseId="nextjs" courses={courses} />;
  }
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6">
              NEXT.JS <span className="gradient-text">COURSE</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Build modern full-stack web applications with Next.js 15, App Router, and React Server Components!
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="glass-card p-8 rounded-2xl h-full flex flex-col card-hover">
                <div className="h-32 rounded-2xl mb-6 flex items-center justify-center bg-gradient-to-br from-violet-400 to-purple-600 shadow-lg">
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                ...
                <h3 className="text-3xl font-bold text-white mb-4">NEXT.JS FUNDAMENTALS</h3>
                <p className="text-gray-300 mb-6 flex-grow leading-relaxed">
                  Learn Next.js 15 with App Router, Server Components, Server Actions, and deployment. Build production-ready applications.
                </p>
                ...
                <Link
                  href="/courses/nextjs?start=true"
                  className="w-full py-4 px-6 bg-gradient-to-r from-violet-500 to-purple-500 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group hover:scale-105"
                >
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            >
              <h3 className="text-2xl font-bold text-purple-400 mb-6 flex items-center gap-3">
                ...
                Next.js Course Content
              </h3>
              <ul className="grid md:grid-cols-2 gap-3">
                {[
                  'Next.js 15 setup and project structure',
