...
export default function JavaScriptCoursePage() {
  ...
  if (startLearning && !loading) {
    return <CourseViewer courseId="javascript" courses={courses} />;
  }
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6">
              JAVASCRIPT <span className="gradient-text">COURSE</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              Complete JavaScript training from beginner to advanced - Master the language of the web!
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              <div className="glass-card p-8 rounded-2xl h-full flex flex-col card-hover">
                <div className="h-32 rounded-2xl mb-6 flex items-center justify-center bg-gradient-to-br from-yellow-400 to-orange-600 shadow-lg">
                  <motion.span
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                ...
                <h3 className="text-3xl font-bold text-white mb-4">JAVASCRIPT COURSE</h3>
                <p className="text-gray-300 mb-6 flex-grow leading-relaxed">
                  Complete JavaScript training from basic to advanced. Master variables, functions, DOM manipulation, async JavaScript, ES6+ features, and build real projects.
                </p>
                <div className="flex items-center gap-2 text-gray-400 mb-6">
                  <span className="text-sm">📖</span>
                  <span className="text-sm">Basic to Advanced</span>
                  <span className="text-gray-500">•</span>
                  <span className="text-sm">21 Chapters Total</span>
                </div>
                <Link
                  href="/courses/javascript?start=true"
                  className="w-full py-4 px-6 bg-gradient-to-r from-yellow-500 to-orange-500 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center gap-2 group hover:scale-105"
                >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Complete JavaScript curriculum from basic to advanced
            </p>
          </motion.div>
            ...
            >
              ...
              <ul className="grid md:grid-cols-2 gap-3">
                {[
                  ...
                  'Projects: Todo App & E-Commerce App',
                ].map((item, index) => (
                  <motion.li
                    key={index}
